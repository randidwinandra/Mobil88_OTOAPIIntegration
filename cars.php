...
// Get cars
$tsql = "SELECT TOP 1000 ID, CREATED_DATE, LAST_MODIFIED_DATE, PLATE_NO, BRANCH_ID, LOCATION_ID, BRAND, MODEL, TYPE, VARIANT, COLOUR, CC, FUEL, TRANSMISSION, MANUFACTURE_YEAR, KM, VEHICLE_REGISTRATION_EXPIRY_DATE, STATUS, IMAGE_THUMBNAIL, CASH_PRICE, GARDAN, MANUAL_BOOK, SERVICE_BOOK, SPARE_KEY FROM MI_CAR $where";
